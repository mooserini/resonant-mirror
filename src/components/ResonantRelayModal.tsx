        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
          {checking ? <p className="text-xs text-[var(--text-secondary)] animate-pulse">CHECKING RELAY IDENTITY…</p> : session && !profile ?
            <form onSubmit={saveHandle} className="max-w-xl mx-auto space-y-4 border border-[var(--border-color)] bg-[var(--bg-secondary)] p-5">
              ...
              <label className="flex items-start gap-2 text-[11px] leading-relaxed text-[var(--text-secondary)]"><input type="checkbox" checked={accepted} onChange={event => setAccepted(event.target.checked)} className="mt-0.5" /><span>I understand that my chosen handle and messages will be visible to Thomas in his private Discord relay, and that Discord processes and retains its copy under its <a className="underline" href="https://discord.com/privacy" target="_blank" rel="noreferrer">privacy policy</a>.</span></label>
            ...
            <div className="grid md:grid-cols-[1.1fr_.9fr] gap-5">
              <form onSubmit={transmit} className="space-y-4 border border-[var(--border-color)] bg-[var(--bg-secondary)] p-5">
                ...
                <label className="flex items-start gap-2 text-[11px] leading-relaxed text-[var(--text-secondary)]"><input type="checkbox" checked={accepted} onChange={event => setAccepted(event.target.checked)} className="mt-0.5" /><span>I understand that my callsign and message go to Thomas through Discord; Discord processes and retains its copy under its <a className="underline" href="https://discord.com/privacy" target="_blank" rel="noreferrer">privacy policy</a>.</span></label>
